                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if(!Auth::guest())
                                ...
                                <a href="{{ route('admin.nom.category.edit',$category->id)}}" class="btn btn-primary">
                        ...
                        <div class="modal-dialog modal-dialog-popin" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body pb-1">
                                    <p><i class="fa fa-fw fa-exclamation-triangle mr-1 text-warning"></i>Are you sure that you want to delete this category?</p>
                                </div>
                                <div class="modal-footer">
                                    <button class="btn btn-rounded btn-outline-primary" data-dismiss="modal" aria-label="Close">
                                        No
                                    </button>
                                    <form action="{{ route('admin.nom.category.destroy',$category->id)}}" method="post" style="display: contents">
