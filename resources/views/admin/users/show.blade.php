                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-5">
                                ...
                                <p><b>Roles:</b> {{ implode(', ', $user->roles->pluck('name')->toArray()) }}<p>
                                <p><b>Permissions:</b> {{ implode(', ', $user->permissions->pluck('name')->toArray()) }}<p>
                            </div>
                        ...
                        <div class="modal-dialog modal-dialog-popin" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body pb-1">
                                    <p><i class="fa fa-fw fa-exclamation-triangle mr-1 text-warning"></i>Are you sure that you want to delete this user?</p>
                                </div>
                                <div class="modal-footer">
                                    <button class="btn btn-rounded btn-outline-primary" data-dismiss="modal" aria-label="Close">
                                        No
                                    </button>
                                    <form action="{{ route('admin.users.destroy',$user->id)}}" method="post" style="display: contents">
